...
#
# Update to Java 8 and Hadoop 2.9.2 using the latest stable Ubuntu
#
# docker build -t hadoop-ubuntu:2.8.1 .
...
# hadoop
RUN curl -s https://www-us.apache.org/dist/hadoop/common/hadoop-2.9.2/hadoop-2.9.2.tar.gz  | tar -xz -C /usr/local/
